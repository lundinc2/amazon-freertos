...
extern const uint8_t ulp_main_bin_start[] asm("_binary_ulp_example_ulp_bin_start");
extern const uint8_t ulp_main_bin_end[]   asm("_binary_ulp_example_ulp_bin_end");
